    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/menu-2.jpg" class="image-popup"><img src="<?php echo IMAGEPRODUCTS; ?>/<?php echo $singelProduct->image; ?>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
				...
				<?php if(isset($_SESSION['user_id'])) : ?>
					<?php if($rowCount > 0) : ?>
						<button style="margin-top: -135px; margin-left: 632px; height: 65px;" name="submit" type="submit" class="btn btn-primary py-3 px-5" disabled>Added to Cart</button>
					<?php else : ?>
						<button style="display: inline-block; position: relative; z-index: 1; padding: 2em; margin: -2em; margin-top: -135px; margin-left: 632px; height: 65px;" name="submit" type="submit" class="btn btn-primary py-3 px-5">Add to Cart</button>
					<?php endif; ?>
				<?php else : ?>
					<p style="margin-top: -135px; margin-left: 632px; height: 65px;">login to add product to cart</p>
				<?php endif; ?>
			</form>
    			</div>
    		</div>
