          ...
          <div class="col-md-12 ftco-animate">
			<form action="checkout.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
		                  ...
		                  <select name="state" id="" class="form-control">
		                  	<option style="background: black;" value="France">France</option>
		                    <option style="background: black;" value="Italy">Italy</option>
		                    <option style="background: black;" value="Philippines">Philippines</option>
		                    <option style="background: black;" value="South Korea">South Korea</option>
		                    <option style="background: black;" value="Hongkong">Hongkong</option>
		                    <option style="background: black;" value="Japan">Japan</option>
		                    <option style="background: black;" value="Indonesia">Indonesia</option>
		                  </select>
		                </div>
		            	</div>
		            </div>
                ...
                <div class="col-md-12">
					...
					<div class="radio">
                      <p><button type="sumbit" name="submit" class="btn btn-primary py-3 px-4">Place an order an pay</button></p>
